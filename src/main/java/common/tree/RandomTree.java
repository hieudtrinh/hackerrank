...
public class RandomTree {
    ...
    public static void main(String[] args) {
         ...
         */
        TreePrinter<TreeNode> printer = new TreePrinter<>(n -> nameForNumber(n.getVal()), n -> n.getLeft(), n -> n.getRight());
        ...
        printer = new TreePrinter<>(n -> ""+n.getVal(), n -> n.getLeft(), n -> n.getRight());
        printer.setHspace(1);
        // use square branches
        printer.setSquareBranches(true);
        printer.printTree(tree);
